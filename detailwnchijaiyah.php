    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Poster Hijaiyah Wipe And Clean - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/hijaiyahwipeclean.jpg" class="img-fluid" id="image" style="width: 70%;">
                    <h4 id="harga" class="harga-detail text-center">Rp. 20.000,.</h4>
            </div>
        </div>
    </div>
    <main role="main">
        <section class="py-5">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
                    ...
                    Poster SECIL Belajar Wipe and Clean bisa dihapus untuk anak - Poster Belajar Anak

Bahan
Art Paper 260 gsm (SANGAT TEBAL) warna putih bukan poster murah yang warna coklat
Dilaminasi Glossy sehingga poster tahan air dan juga bisa dihapus setelah menulis

BONUS SPIDOL wipe and clean untuk setiap pembelian 1 poster menulis wipe and clean

Ukuran
A2 (42cm x 60cm) Super Jumbo
