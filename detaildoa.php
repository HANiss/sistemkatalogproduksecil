    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Poster Do'a Anak Muslim - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/doaanakmuslim1.jpg" class="img-fluid" id="image" style="width: 70%;">
        ...
        <section class="py-5">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
                    ...
                    Poster Kumpulan Doa Anak Muslim Lengkap Design full colour dan menarik untuk anak. Dibuat oleh Solite Kids pengembang game edukasi anak terlaris di play store.

Bahan :
Art Paper 260 gsm Tebal Warna Putih bukan poster murah yang warna coklat
