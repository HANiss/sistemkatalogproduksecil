    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Poster Huruf - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/posterhuruf_baru.png" class="img-fluid" id="image" style="width: 70%;">
        ...
        <div class="row pt-1">
            <div class="col-md-6 col-lg-5 px-3">
                <div class="clearfix">
                    ...
                    </ul><div class="lSAction" style="display: none;"><a class="lSPrev"></a><a class="lSNext"></a></div></div><ul class="lSPager lSGallery" style="margin-top: 5px; transition-duration: 400ms; width: 51.1px; transform: translate3d(0px, 0px, 0px);"></ul></div>
                </div>
            </div>
				<nav>
				...
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        Poster Huruf ABC - Alat Peraga Pendidikan PAUD TK
                        Poster Mengenal Huruf ABC untuk anak

                        Art Paper 310 gsm Tebal Warna Putih bukan poster murah yang warna coklat
                        Ukuran A3 Plus (32cm x 48cm) Sangat Besar
                        Usia : TK atau SD
                        Harga : Untuk 1 Poster bisa pilih judul yang lain
