    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Poster Mengenal Alam Kita - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/petaalamkita.jpg" class="img-fluid" id="image" style="width: 70%;">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        Poster SECIL Lingkungan Alam Kita Sungai Gunung PREIMUM - Alat Peraga Pendidikan PAUD TK
                        Poster Belajar Mengenal Lingkungan Kehidupan untuk anak - Poster Belajar Anak
                        Bahan
                        ...
                        Usia : TK atau SD
                        Harga tertera adalah per pcs

                        STOK : Selalu Ada

                        Note : GRATIS Pipa Selongsongan tebal, dijamin Poster Aman Sampai Tujuan.

                        Untuk pembelian lebih dari satu, tersedia harga paket hemat, silahkan cek di ETALASE yah
