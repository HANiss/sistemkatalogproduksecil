    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Flashcard Angka - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/fc-angka.png" class="img-fluid" id="image" style="width: 70%;">
                    <h4 id="harga" class="harga-detail text-center">Rp. 29.940,.</h4>
            </div>
        </div>
    </div>
    <main role="main">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        Flashcard Angka dan Berhitung, Kartu Pintar Berhitung, Belajar Mengenal Angka, Menulis Angka dan Berhitung untuk Anak
                        Flashcard Angka ini dibuat oleh Pengembang Game Edukasi Solite Kids di Play Store.

                        Bahan
                        Kertas ArtPaper 310 gram Cetak 2 Sisi Fullcolor

                        Ukuran BESAR
                        7 cm x 10.5 cm rounded di pojok sehingga aman untuk anak.

                        TOTAL ISI 64 Kartu Bolak Balik (TEBAL SEKALI)
                        - 40 Kartu Mengenal Angka 1 - 40 (di belakang kartu angka ada gambar benda yang jumlahnya sesuai dengan angka di kartu depan, jadi anak belajar menghitung jumlah benda sesuai dengan angka di kartu depan)
                        - 9 Kartu Angka Mengenal Puluhan Ratusan Hingga Ribuan
                        - 5 Kartu Operator Berhitung yang bisa digunting dan dipake untuk bermain tebak berhitung
                        - 10 Kartu Untuk Belajar Menulis Angka dilengkapi dengan Pola petunjuk menulis yang memudahkan anak-anak.

                        DESIGN GAMBAR ORIGINAL buat sendiri karena kami pengembang game pendidikan anak professional sehingga gambar yang dihasilkan juga tidak akan mengecewakan ayah dan bunda.

                        - Brosur Panduan Cara bermain dengan flashcard dengan lebih dari 6 model permainan yang bisa dimainakan.
                        - Bonus Aplikasi Game Belajar Angka dari Solite Kids di Playstore

                        Di belakang kartu juga dilengkapi dengan tabel perkalian dan pembagian sehingga bisa dipake anak-anak sekolah untuk belajar menghafal tabel perkalian.

                        SEMUA GAMBAR yang ada pada flashcard ini dibuat kami Solite Kids, pengembang game anak indonesia di Play Store. 

                        Lihat Produk Flashcard dan Poster kami yang lain di ETALASE kami. Ada Paket Harga Super Hemat Jika membeli beberapa jenis produk.
                    </div>
