    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Poster Pengurangan - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/pengurangan.jpg" class="img-fluid" id="image" style="width: 70%;">
                    <h4 id="harga" class="harga-detail text-center">Rp. 7.000,.</h4>
            </div>
        </div>
    </div>
    <main role="main">
        <section class="py-5">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
                    ...
                    Poster Tabel Matematika untuk membantu anak menghafal perkalian pembagian pengurangan dan penjumlahan. Silahkan pilih tipe variasi poster yang ingin di order.

Harga tercantum adalah harga per pcs yah.

1. Poster Perkalian
2. Poster Pembagian
3. Poster Penjumlahan
4. Poster Pengurangan
