    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Flashcard Hijaiyah - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/fc-hijaiyah.png" class="img-fluid" id="image" style="width: 70%;">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        Flashcard Hijaiyah Alif Ba Ta Tsa, Kartu Pintar Huruf Hijaiyah, Belajar Bahasa Arab dan Angka Arab Serta Belajar Iqro
                        Flashcard Hijaiyah ini dibuat oleh Pengembang Game Edukasi Solite Kids di Play Store.

                        TOTAL ISI 64 Kartu Bolak Balik (TEBAL SEKALI)
                        - 30 Kartu Huruf Hijaiyah Alif Ba Ta (di belakang kartu huruf alif dilengkapi benda dalam bahasa arab yang diawali oleh huruf alif seperti Abun = Ayah, Ba' = Baqorotun = Sapi)
                        - 6 Kartu Iqro Dasar Bolak balik total 12 kalimat dasar bahasa arab untuk belajar mengaji iqro'
                        - 10 Kartu Doa Anak Muslim Beserta Arti
                        - 8 Kartu Harokat dan Tanwin untuk permainan belajar mengaji
                        - 10 Kartu Angka 1-10 dalam bahasa arab. 
                        ...
                        - Bonus Aplikasi Game Belajar Hijaiyah dari Solite Kids di Playstore

                        Di belakang kartu ada objek benda yang berawalan huruf tersebut
                        Misal Alif = Abun = Ayah
                        Misal Ba' = Baqorotun = Sapi
                        Sampai huruf ya'
