    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Flashcard Huruf ABC - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/fc-huruf.png" class="img-fluid" id="image" style="width: 70%;">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        Flashcard Huruf ABC untuk PAUD
                        Flashcard Huruf ABC dari Pengembang Game Edukasi Solite Kids di Play Store
                        TOTAL 64 Kartu Bolak Balik Tebal Sekali
                        - 26 Kartu Huruf Besar
                        - 26 Kartu Huruf Kecil
                        - 12 Kartu Bentuk dan Warna
                        - Brosur Panduan Cara bermain dengan flashcard dengan lebih dari 6 model permainan yang bisa dimainakan.
                        - Bonus Aplikasi Game Belajar Huruf ABC dari Solite Kids di Playstore
