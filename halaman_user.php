<html>
 ...
 ?>
        ...
        <div class="row" >    
                <div class="col-xl-4 col-sm-4 col-xs-5 pt-1">              
                    <div class="d-flex align-items-center"> 
                        <a href="https://api.whatsapp.com/send?phone=6282333574407&text=Halo%20saya%20tertarik%20dengan%20produk%20%2aSecil%20Mainan%2a%2c%20mohon%20penjelasannya&source=&data=&app_absent=" target="_BLANK">
                            <img class="img-fluid" src="gambar/icon/chatwhatsapp.png">
                        </a>
                    </div>
                </div>
            <div class="col-xl-2 col-sm-1 col-xs-1 pt-1 px-0 justify-content-right text-right align-items-center my-auto">
                <img class="img-fluid" src="gambar/icon/gratis-ongkir.png">
            </div>
            <div class="col-xl-4 col-sm-5 col-xs-5 pt-1">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white">
                <button type="button" aria-label="Toggle navigation" class="navbar-toggler not-collapsed" aria-expanded="true" aria-controls="nav-collapse">
        ...
        <center><p>Halo <b><?php echo $_SESSION['username']; ?></b> Anda telah login sebagai <b><?php echo $_SESSION['status']; ?></b>.</p>
	<a href="logout.php">LOGOUT</a>
    </center>
        <div class="container-fluid">
            <div class="row justify-content-center align-items-center" style="padding: 1rem 3rem 0 3rem;">
                <div class="col-xl-6 col-sm-6 col-xs-6 text-center">
                    <a href="poster.php">
                        <img class="img-fluid" src="gambar/gambarproduk/poster.png">
                    </a>
                </div>
                <div class="col-xl-6 col-sm-6 col-xs-6 text-center">
                    <a href="flashcrad.php">
                        <img class="img-fluid" src="gambar/gambarproduk/flashcard.png">
                    </a>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row justify-content-center align-items-center" style="padding: 1rem 3rem 0 3rem;">
                <div class="col-xl-6 col-sm-6 col-xs-6 text-center">
                    <a href="ulartangga.php">
                        <img class="img-fluid" src="gambar/gambarproduk/ulartangga.png">
                    </a>
                </div>
                <div class="col-xl-6 col-sm-6 col-xs-6 text-center">
                    <a href="stikerdoa.php">
                        <img class="img-fluid" src="gambar/gambarproduk/stiker.jpg">
                    </a>
                </div>
            </div>
