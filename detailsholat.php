    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Poster Sholat - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/sholat.jpg" class="img-fluid" id="image" style="width: 70%;">
        ...
        <section class="py-5">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
                    ...
                    Poster Belajar Tata Cara Shalat Lengkap Dengan Niat dan Doa Shalat untuk anak - Poster Belajar Anak

                        Bahan
                        Art Paper 260 gsm (SANGAT TEBAL) warna putih bukan poster murah yang warna coklat
                        Laminasi Glossy jadi tahan air

                        Ukuran
                        A2 (42cm x 60cm) SUPER JUMBO Doa terlihat jelas
