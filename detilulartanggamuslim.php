    ...
    <div class="container-fluid">
        <div class="row pt-2">
            <div class="col-12 my-auto">
                ...
                <span class="align-middle" style="font-size: 1rem; font-weight: bold;" id="nama">Ular Tangga Anak Muslim - Alat Peraga Pendidikan PAUD TK</span>
            </div>
        ...
        <div class="row my-2 justify-content-bentween align-items-top">
            <div class="col-lg-6 col-sm-4 col-4 text-center">
                <img src="gambar/gambarproduk/ulartanggaijo.jpg" class="img-fluid" id="image" style="width: 70%;">
                    <h4 id="harga" class="harga-detail text-center">Rp. 25.000,.</h4>
            </div>
        </div>
    </div>
    <main role="main">
        <section class="py-5">
            ...
            <div class="col-md-6 col-lg-5 px-3">
				...
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">Ular Tangga Anak Muslim - Alat Peraga Pendidikan PAUD TK 
                        Board Game Ular Tangga Anak dari Solite Kids Seri Edukasi Anak

                        Ada 3 Model Papan Ular tangga yang bisa dipilih, silahkan pilih di variasi
                        1. Ular Tangga Anak Basic
                        2. Ular Tangga Anak Muslim
                        3. Ular Tangga Anak Sehat

                        Isi dalam paket :
                        1. Papan Ular Tangga (1pcs)
                        2. Dadu (1pcs)
                        3. Pion (3 pcs)

                        Jika ingin membeli tambahan dadu ataupun pion silahkan cek di etalase yah bagian kategori board game
                    </div>
